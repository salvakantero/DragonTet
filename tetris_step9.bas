...
100 TRUE = -1: FALSE = 0
110 ReDim PITLEFT(1)
120 PITLEFT(0) = 1: PITLEFT(1) = 23
130 ReDim NAMES$(6): ReDim SCORES(6)
140 For I = 0 To 4
    150 NAMES$(I) = "DRAGON"
    160 SCORES(I) = 1400 - (I * 100)
170 Next I
...
2010 If SCORES(PI) > SCORES(4) Then
    ...
    2030 Locate 10, 6: Print "GREAT SCORE PLAYER " + Str$(I + 1)
    2040 Locate 11, 6: Input "NAME?: ", NAMES$(PI)
...
3090 KEY$ = ""
3100 KEY$ = InKey$
3110 If KEY$ = "" Then 3100
3120 If KEY$ = "1" Then NUMPLAYERS = 0: Return
3150 If KEY$ = "2" Then NUMPLAYERS = 1: Return
3180 If KEY$ = "3" Then 3190
3185 GoTo 3320
3190 For I = 0 To 4
    3200 Locate 9 + I, 9
    3210 Print "................"
...
3285 KEY$ = ""
3290 KEY$ = InKey$
3300 If KEY$ = "" Then 3290
3310 GoTo 3000 'MENU SUB
3320 If KEY$ = "4" Then End
3360 Return
...
9020 STARTTIME!(0) = Timer
9022 ROTATEKEY$(0) = "w": DOWNKEY$(0) = "s": LEFTKEY$(0) = "a", RIGHTKEY$(0) = "d"
9024 If NUMPLAYERS > 0 Then 
    9026 STARTTIME!(1) = Timer
    9028 ROTATEKEY$(1) = "i": DOWNKEY$(1) = "k": LEFTKEY$(1) = "j", RIGHTKEY$(1) = "l"
9029 End if
